package tcking.github.com.rfm.aacplay.library.radio;
...
public class RadioPlayerService extends Service implements PlayerCallback {
     ...
     */
    public static final String NOTIFICATION_INTENT_PLAY_PAUSE = "co.romanticfm.library.notification.radio.INTENT_PLAYPAUSE";

    public static final String NOTIFICATION_INTENT_CANCEL = "co.romanticfm.library.notification.radio.INTENT_CANCEL";

    public static final String NOTIFICATION_INTENT_OPEN_PLAYER = "co.romanticfm.library.notification.radio.INTENT_OPENPLAYER";
     ...
     */
    public static final String ACTION_MEDIAPLAYER_STOP = "co.romanticfm.library.ACTION_STOP_MEDIAPLAYER";
