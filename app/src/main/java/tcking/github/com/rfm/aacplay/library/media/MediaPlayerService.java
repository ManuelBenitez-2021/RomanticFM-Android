package tcking.github.com.rfm.aacplay.library.media;
...
public class MediaPlayerService extends Service implements
     ...
     */
    public static final String NOTIFICATION_INTENT_PLAY_PAUSE = "co.romanticfm.library.notification.media.INTENT_PLAYPAUSE";

    public static final String NOTIFICATION_INTENT_CANCEL = "co.romanticfm.library.notification.media.INTENT_CANCEL";

    public static final String NOTIFICATION_INTENT_OPEN_PLAYER = "co.romanticfm.library.notification.media.INTENT_OPENPLAYER";
    ...
    private int smallImage = R.drawable.zu_small_logo;
    ...
    private void buildNotification(){
         ...
         */
        if(artImage == null)
            artImage = BitmapFactory.decodeResource(getResources(),R.drawable.zu_small_logo);
        ...
        mNotificationTemplate.setOnClickPendingIntent(R.id.notification_image, openPending);
        /**
     ...
     /*   Intent notificationIntent = new Intent(this, MainActivity.class);
        ...
        notification.icon = R.drawable.zu_small_logo;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            mExpandedView.setOnClickPendingIntent(R.id.notification_image, openPending);
